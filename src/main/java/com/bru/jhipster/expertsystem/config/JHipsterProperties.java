...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ExpertSystem@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ExpertSystem API";

        private String description = "ExpertSystem API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "ExpertSystem";
